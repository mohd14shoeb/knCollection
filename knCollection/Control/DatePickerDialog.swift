/*
    Great lib from https://github.com/squimer/DatePickerDialog-iOS-Swift
 */
...
class DatePickerDialog: UIView {
    ...
    fileprivate func addButtonsToView(_ container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(buttonTapped(_:)), for: UIControlEvents.touchUpInside)
